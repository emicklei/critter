Critter is a standalone http proxy server with features to simulate communication problems per request.
...
Other proxies: http://proxies.xhaus.com/java/  (SSL from ZAP http://code.google.com/p/zaproxy/wiki/Introduction)

(c)2012, ernest.micklei@gmail.com  